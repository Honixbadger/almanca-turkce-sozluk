...
class DesktopDictionaryApp(tk.Tk):
    ...
    def _build_ui(self) -> None:
        ...
        self.overview_tab = ttk.Frame(self.details_notebook, padding=12)
        ...
        self.details_notebook.add(self.overview_tab, text="Kısa Bilgi")
    ...
    def _build_overview_tab(self) -> None:
        ...
        detail_text_wrap.grid(row=1, column=0, sticky="nsew", pady=(8, 14))
        detail_text_wrap.columnconfigure(0, weight=1)
        detail_text_wrap.rowconfigure(0, weight=1)
        self.detail_text = tk.Text(detail_text_wrap, height=12, wrap="word", relief="flat", padx=10, pady=10)
        ...
        related_wrap.grid(row=3, column=0, sticky="nsew", pady=(8, 0))
        related_wrap.columnconfigure(0, weight=1)
        related_wrap.rowconfigure(0, weight=1)
        self.related_listbox = tk.Listbox(related_wrap, exportselection=False, height=7)
